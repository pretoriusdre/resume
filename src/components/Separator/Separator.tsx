...
import { RelativePosition, ResumeTree } from '../../types/resume';
...
const Separator: React.FC<SeparatorProps> = ({ id, materialised_path, relative_position }) => {
